...
To send a message to the default panel, click `Developer -> html-template -> Send Message to Panel` at the top of the menu. If the default panel exists, the `hello` method of the panel will be called.
